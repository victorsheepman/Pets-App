...
const Home = () => {
    const view = 
        ...
        <section class="pet close" id="petmodal">
        <figure class="pet__img">
            <img src="assets/images/img.png" alt="" srcset="">
        </figure>
        <article class="pet__container">
            <div class="pet__info">
                ...
                <article class="pet__history">
                    ...
                    <p class="body-2">Rocky es un perrito muy lindo y cariñoso, tiene 5 hermanitos más y por cuestiones de espacio y tiempo no podremos cuidar a todos, nuestra misión es encontrar la familia ideal para él y seguro que tú eres la persona indicada.</p>
